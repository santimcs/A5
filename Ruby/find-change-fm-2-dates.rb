...
# Get command line arguments for date1, date2, and folder name
date1 = ARGV[0]
date2 = ARGV[1]
folder_name = ARGV[2]

# Open input and output CSV files
input_file = File.join(ENV['USERPROFILE'], 'OneDrive', folder_name, 'Data', 'buy-input.csv')
output_file = File.join(ENV['USERPROFILE'], 'OneDrive', folder_name, 'Data', 'prices-change.csv')
